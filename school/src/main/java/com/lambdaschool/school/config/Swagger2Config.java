...
public class Swagger2Config
{
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2)
                .select().apis(RequestHandlerSelectors.basePackage("com.lambdaschool.school"))
    ...
    private ApiInfo apiEndPointsInfo()
    {
        return new ApiInfoBuilder().title("School Example")
                ...
                .contact(new Contact("Brandon Porter", "www.brandonporter.me", "brandon.porter.10.06@gmail.com"))
